...
# gerenciamento_laboratorial/
APPS_DIR = BASE_DIR / "gerenciamento_laboratorial"
env = environ.Env()
...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres:///gerenciamento_laboratorial",
    ),
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "gerenciamento_laboratorial.users.context_processors.allauth_settings",
            ],
        },
    },
]
